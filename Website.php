...
<nav class="navbar sticky-top navbar navbar-expand-lg navbar-dark bg-dark"> <!-- NAVBAR -->
  ...
  <div class="container">
    <a class="navbar-ecglogo" href="#">
      <img src="Images/ecglogo.jpg" alt="" width="70" height="70">
    </a>
  </div>
</nav>
...
<section class="membership scroll-reveal" id="membership" tabindex="-1" aria-label="Membership section"> <!-- MEMBERSHIP SECTION-->
    ...
    <article class="card" tabindex="0" aria-labelledby="student-title" role="region">
      <img src="Images/student.jpg" alt="Student Gym Membership card image with gym equipment design" class="card-image" />
    ...
    <article class="card" tabindex="0" aria-labelledby="nonstudent-title" role="region">
      <img src="Images/non.jpg" alt="Non-Student Gym Membership card image with modern gym interior" class="card-image" />
      <div class="card-content">
    ...
    <article class="card" tabindex="0" aria-labelledby="general-info-title" role="region">
      <img src="Images/general.jpg" alt="Photo showing gym rules and general membership information" class="card-image" />
      <div class="card-content">
  ...
  <br>
    ...
    <div class="tr-cards">
      ...
      <div class="training-card">
        <img src="Images/muay.jpg" alt="MUAY THAI" />
        <div class="info">
          <h3>MUAY THAI</h3>
      ...
      <div class="training-card">
        <img src="images/circuit.jpg" alt="CIRCUIT TRAINING" />
        <div class="info">
...
<!-- ADDED class="scroll-reveal" -->
    ...
    <div class="content-wrapper">
      <div class="aboutimage-container">
        <img src="Images/ecgbslogo.jpg" alt="Ecg Picture" />
      </div>
