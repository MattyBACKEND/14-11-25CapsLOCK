...
<div class="main content w-full p-8 md:p-10 lg:p-12">
    ...
    <div class="mb-8 flex space-x-4 overflow-x-auto scrollbar-thin no-scrollbar-safari justify-center">
        ...
        <button class="flex-shrink-0 px-6 py-2 text-base font-bold rounded-full text-white bg-blue-600 shadow-lg shadow-blue-500/50 hover:bg-blue-700 transition-colors focus:outline-none" aria-current="true">Arm</button>
    ...
    >
        ...
        <a href="Arms-beginner.php" class="no-underline">
            <div class="min-w-[380px] flex-shrink-0 bg-white rounded-2xl p-4 shadow-2xl hover:ring-4 hover:ring-blue-600 transition-all duration-200 cursor-pointer select-none">
                <div class="relative mb-4">
                    <img
                        src="https://www.trainheroic.com/wp-content/uploads/2023/01/AdobeStock_298511434-TH-jpg.webp"
                        alt="Arms Beginner"
                ...
                <h3 class="font-black text-2xl text-gray-900 leading-tight mb-2">ARM FOUNDATION</h3>
                <p class="text-gray-600 mt-1 text-base">Build strength and size with basic bicep and tricep movements.</p>
        ...
        <a href="Arms-intermediate.php" class="no-underline">
            <div class="min-w-[380px] flex-shrink-0 bg-white rounded-2xl p-4 shadow-2xl hover:ring-4 hover:ring-blue-600 transition-all duration-200 cursor-pointer select-none">
                <div class="relative mb-4">
                    <img
                        src="https://sfhealthtech.com/cdn/shop/articles/bobybuilder-doing-arms-workout.jpg?v=1717501481"
                        alt="Arms Intermediate"
                        class="w-full h-40 rounded-xl object-cover"
                        loading="lazy"
                    />
                ...
                <h3 class="font-black text-2xl text-gray-900 leading-tight mb-2">ARM POWER UP</h3>
                <p class="text-gray-600 mt-1 text-base">Compound movements and supersets to increase volume and intensity.</p>
        ...
        <a href="Arms-advanced.php" class="no-underline">
            <div class="min-w-[380px] flex-shrink-0 bg-white rounded-2xl p-4 shadow-2xl hover:ring-4 hover:ring-blue-600 transition-all duration-200 cursor-pointer select-none">
                <div class="relative mb-4">
                    <img
                        src="https://blogscdn.thehut.net/app/uploads/sites/478/2020/07/iStock-602331216opt_featured_1595000241.jpg"
                        alt="Arms Advanced"
                        class="w-full h-40 rounded-xl object-cover"
                        loading="lazy"
                    />
                ...
                <h3 class="font-black text-2xl text-gray-900 leading-tight mb-2">ELITE ARM SHREDDER</h3>
                <p class="text-gray-600 mt-1 text-base">High-volume intensity training for maximum peak and definition.</p>
                
                <div class="flex justify-between items-center mt-4 pt-4 border-t-2 border-gray-200">
                    <div class="text-base">
                        <p class="font-bold text-gray-800">⏱️ <span class="text-lg">70 - 80</span> mins</p>
                        <p class="font-semibold text-gray-500">🏋️ 7 Exercises</p>
                    </div>
                    <div class="flex space-x-1 items-center">
                        <span class="text-sm font-bold text-gray-700">Difficulty:</span>
